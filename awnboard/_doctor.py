"""Stack-aware `doctor` for awnboard.
...
interesting failures live BETWEEN them. "awnboard is installed" is not the useful
fact -- "awnboard is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awnboard'
FAMILY = ['awbac', 'awbrowse', 'awdit', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnest', 'awnet', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awbac', 'awdit', 'awiam', 'awmail', 'awnest', 'awnet', 'awseal', 'awshare', 'awtunnel']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awnboard needs at runtime, and a
